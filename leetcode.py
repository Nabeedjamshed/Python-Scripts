...
# #         print() 1
# #     else:
# #         print() tribonacci(n - 1) + tribonacci(n - 2) + tribonacci(n - 3)
...
# #             print() self.addDigits(self.sum_l)
...
# # modified_string = ''.join([char for char in paragraph if char not in ',.'])
# # paragraph_new = (modified_string.lower()).split()
# # banned = ["hit"]
# # new_banned = "".join(banned)
# # d = {}
# # for i in paragraph_new:
# #     if i not in d:
# #         a = paragraph_new.count(i)
# #         d[i] = a
# #     else:
# #         a += 1
# # for i in d.keys():
...
# # sth = int(input("Math marks out of 100:"))
...
# # totalmarks = 500
# # obtainmarks = physics+math+computer+islamiat+english
# # percentage = ((obtainmarks/500)*100)
# # print (percetudentname = input("Enter your name:")
# # physics = int(input("Physics mark out of 100:"))
# # mantage)
...
# # for i in range(len(nums)):
# #     for j in range(i,len(nums)):
# #         subarray.append(min(nums[i:j+1]))
# # print(sum(subarray))
...
# l = []
# for x,y in d1.items():
#     if x not in d2.keys() and y == 1:
#         l.append(x)
# for x,y in d2.items():
#     if x not in d1.keys() and y == 1:
#         l.append(x)
# print(l)
